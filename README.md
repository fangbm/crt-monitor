...
复古 CRT 风格的副屏系统监控仪表盘。**v1.0**：托盘常驻、告警中心、每核热力图、磁盘指示灯、媒体卡（滚轮调音量）、Ping 延迟/丢包曲线、系统事件卡、GPU 深度卡、开机统计、3 日预报、分网卡速率、今日流量、截图、防灼屏微抖、远程多机监控、脚本数据源、**布局预设（P 键）**、**主题编辑器（可视化调色）**、更新检查、自由布局 + 卡片管理器、多页面、11 套主题、C#/JS 插件、1H–7D 历史 + 昨日对比。免管理员安装。
